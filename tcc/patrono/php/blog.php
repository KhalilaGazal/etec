...
<body>
  <?php 
    ...
    $consult = $pdo->query("SELECT * FROM material m JOIN material_categoria c ON m.id_categoria = c.id WHERE c.nome = 'Blog' ORDER BY m.id;");
  ?>
  <div class="container container-light col-12 col-sm-10 col-lg-7">
    <h1 class="titulo-hp text-center">Blogs</h1>
    <p>Clique no título do blog para visitá-lo.</p>
    <ul>
