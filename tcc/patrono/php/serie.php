...
<body>
  <?php 
    ...
    $consult = $pdo->query("SELECT *, m.id id_material FROM material m JOIN material_categoria c ON m.id_categoria = c.id WHERE c.nome = 'Série' ORDER BY m.id;");
  ?>
  <div class="container container-light col-12 col-sm-10 col-lg-7">

    <h1 class="titulo-hp text-center">Séries</h1>
    <p>Clique no título da série para mais informações.</p>
